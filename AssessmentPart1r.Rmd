...
setwd("D:/Xin/MSc Smart Cities and Urban Analytics/Modules/CASA0005 GISS/Assessment Part 1")
...
ggmap(London_map) + geom_point(aes(x = Long, y = Lat, size=sqrt(StnUsg17)), data = StnUsg17, alpha = 0.8, color="red")+ scale_size(range=c(0.5,8))
